module DataConcern
  ...
  def self.get_info(sym, auth_token, strike = "")
    ...
    request_url = "https://api.tdameritrade.com/v1/marketdata/chains?apikey=#{ENV['TD_CONSUMER_KEY']}&symbol=#{sym}&contractType=CALL&strikeCount=12&includeQuotes=TRUE&strategy=SINGLE&range=SBK&toDate=#{date}&fromDate=#{date}&optionType=S&strike=#{strike}"
